...
import com.letrungquyen.test.databinding.ActivityAddBinding;
...
public class AddActivity extends AppCompatActivity {
        ...
        launcher = registerForActivityResult(new ActivityResultContracts
            ...
            public void onActivityResult(ActivityResult o) {
                if(o.getResultCode() == RESULT_OK && o.getData() != null){
                    ...
                    binding.imgOto.setImageBitmap(bitmap);
                }
            }
        });
    ...
    private void addEvent() {
        ...
        binding.btnSave.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    String name = binding.edtOtoName.getText().toString().trim();
                    double price = Double.parseDouble(binding.edtOtoPrice.getText().toString());
                    String des = binding.edtOtoDes.getText().toString().trim();
                    String cate = binding.edtOtoType.getText().toString().trim();
    ...
    private byte[] convertPhoto() {
        BitmapDrawable drawable = (BitmapDrawable) binding.imgOto.getDrawable();
